                ...
                {filteredProducts().length > 0 ? (
                  filteredProducts().map((product) => (
                    <TableRow key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                      <TableCell className="text-gray-800 dark:text-gray-100">{product.productName}</TableCell>
                      ...
                      <TableCell className="text-gray-600 dark:text-gray-400">
                        {product?.companyName ? `Company: ${product.companyName}` : `Branch: ${product?.shop_name || "N/A"}`}
                      </TableCell>
                      <TableCell>
